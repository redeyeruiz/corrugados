            ...
            <div class="center">
                ...
                if(isset($_POST["descarga"])){
                        ...
                        while ($reg=mysqli_fetch_object($sql)){
                            $linea=$reg->idCompania.",".$reg->idLista.",".$reg->idArticulo.",".$reg->nivelDscto.",".$reg->cantOlimp.",".$reg->precio.",".$reg->descuento.",".$reg->impDesc.",".$reg->fechaCaducidad.",".$reg->fechaInicio.",".$reg->estatus;
