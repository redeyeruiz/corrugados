            ...
            <table border="0" width="50%" align="center">
                <form name="f_agentes">
                    <tr>
                        ...
                        <td align="center">
                            <input style="border:3px solid #ff880e" name="id_rep_age" type="text" size="50" maxlength="10" class="campo">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td align="center">
                            <input style="border:3px solid #ff880e" name="id_comp_age" type="text" size="50" maxlength="4" class="campo">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td align="center">
                            <input style="border:3px solid #ff880e" name="nom_rep" type="text" size="50" maxlength="50" class="campo">
                        </td>
                    </tr>
                </form>
            </table>
