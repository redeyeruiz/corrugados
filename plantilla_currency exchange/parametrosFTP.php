...
if(!isset($_SESSION['conectado'])){
    ...
    die();
}elseif(!verificacion_permiso($_SESSION['usuario'], 'Parametros FTP')){
        ...
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_center">
                            <h2><span class="theme_color"></span>Parametros FTP</h2>
                        </div>
                    </div>
                </div>
            </div>
            <table border="0" width="50%" align="center">
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" name="datos">
                    <tr>
                        <td>
                            <p align="center"><b>Servidor</b></p>
                        </td>
                        <td align="center">
                            <input style="border:3px solid #ff880e" name="servidor" type="text" size="50" maxlength="20" class="campo" value="<?= $servidor ?>">
                            <p><span style="color:#C84810" class="error"><?= $servidor_error ?></span></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td align="center">
                            <input style="border:3px solid #ff880e" name="user" type="text" size="50" maxlength="20" class="campo" value="<?= $user ?>">
                            <p><span style="color:#C84810" class="error"><?= $user_error ?></span></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td align="center">
                            <input style="border:3px solid #ff880e" name="contrasena" type="text" size="50" maxlength="225" class="campo" value="<?= $contrasena ?>">
                            <p><span style="color:#C84810" class="error"><?= $contrasena_error ?></span></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td align="center">
                            <input style="border:3px solid #ff880e" name="puerto" type="text" size="50" maxlength="20" class="campo" value="<?= $puerto ?>">
                            <p><span style="color:#C84810" class="error"><?= $puerto_error ?></span></p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
